...
export async function updateById(req, res) {
	...
	try {
		...
		existingService.feedback = req.body.feedback || existingService.feedback;
		existingService.stars = req.body.stars || existingService.stars;
